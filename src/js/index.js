...
personagens.forEach(personagem => {
    personagem.addEventListener('mouseenter', () => {
        ...
        const descricaoPersonageGrande = document.getElementById('descricao-personagem')
        descricaoPersonageGrande.innerText = personagem.getAttribute('data-description');
    })
})
